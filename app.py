...
DeviceProtection = st.selectbox("DeviceProtection", options=[0, 1], format_func=lambda x: "Male" if x else "Female")
TechSupport = st.selectbox("TechSupport", options=[0, 1], format_func=lambda x: "Male" if x else "Female")
StreamingTV = st.selectbox("StreamingTV", options=[0, 1], format_func=lambda x: "Male" if x else "Female")
StreamingMovies = st.selectbox("StreamingMovies", options=[0, 1], format_func=lambda x: "Male" if x else "Female")
Contract = st.selectbox("Contract", Contract_list)
PaperlessBilling = st.selectbox("GePaperlessBillingnder", options=[0, 1], format_func=lambda x: "Male" if x else "Female")
